...
alter table rental_form add rental_id int;
alter table rental_form drop column rental_id;

insert into  Rental_form (rental_date,Return_date,The_rental_period,The_rental_price,user_id ,car_id) values ('9-7-2020','12-7-2020','2months',8055,5,3);
insert into  Rental_form (rental_date,Return_date,The_rental_period,The_rental_price,user_id ,car_id) values ('12-15-2020','4-15-2021','5months',10250,7,1);
insert into  Rental_form (rental_date,Return_date,The_rental_period,The_rental_price,user_id ,car_id) values ('7-12-2020','12-12-2020','5months',9990,4,2);
insert into  Rental_form (rental_date,Return_date,The_rental_period,The_rental_price,user_id ,car_id) values ('1-17-2020',null,'4months',6650,6,4);
insert into  Rental_form (rental_date,Return_date,The_rental_period,The_rental_price,user_id ,car_id) values ('3-21-2020','10-17-2020','7months',10550,3,5);
...
#8 
select upper (the_manufacture_company) from car;
...
-select sum (The_rental_price),rental_id from rental_form group by rental_id;
...
##update
-update car_user set fullname='islam mohamed', email='islam 99' where user_id=2;

-update car set color='brown' where car_id=3;

-update rental_form set return_date ='1-21-2020' where car_id=5;
...
#delete
-delete from car_user where user_id=4;

-delete from rental_form where The_rental_period='5months';

-delete from car_user where fullname='aya mahmoud';
